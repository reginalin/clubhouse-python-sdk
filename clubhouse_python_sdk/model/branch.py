...
class Branch(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, deleted, entity_type, id, merged_branch_ids, name, persistent, pull_requests, repository_id, updated_at, url, *args, **kwargs):  # noqa: E501
