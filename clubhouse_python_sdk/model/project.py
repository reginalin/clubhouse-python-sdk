...
class Project(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'abbreviation': (str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'id': 'id',  # noqa: E501
        'iteration_length': 'iteration_length',  # noqa: E501
        'name': 'name',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, abbreviation, app_url, archived, color, created_at, days_to_thermometer, description, entity_type, external_id, follower_ids, id, iteration_length, name, show_thermometer, start_time, stats, team_id, updated_at, *args, **kwargs):  # noqa: E501
