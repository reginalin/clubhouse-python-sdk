...
class CreateStories(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'stories': ([CreateStoryParams],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, stories, *args, **kwargs):  # noqa: E501
        """CreateStories - a model defined in OpenAPI
