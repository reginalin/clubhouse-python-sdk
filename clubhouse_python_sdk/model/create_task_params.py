...
class CreateTaskParams(ModelNormal):
    ...
    def __init__(self, description, *args, **kwargs):  # noqa: E501
        """CreateTaskParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            created_at (datetime): Defaults to the time/date the Task is created but can be set to reflect another creation time/date.. [optional]  # noqa: E501
            ...
            updated_at (datetime): Defaults to the time/date the Task is created in Clubhouse but can be set to reflect another time/date.. [optional]  # noqa: E501
        """
