...
class CreateFileObj(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, content_type, filename, size, tempfile, *args, **kwargs):  # noqa: E501
        """CreateFileObj - a model defined in OpenAPI
