...
class Comment(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_url, author_id, created_at, entity_type, external_id, group_mention_ids, id, member_mention_ids, mention_ids, position, reactions, story_id, text, updated_at, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            reactions ([Reaction]): A set of Reactions to this Comment.
