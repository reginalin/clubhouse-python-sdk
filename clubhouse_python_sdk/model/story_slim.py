...
class StorySlim(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'num_tasks_completed': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'comment_ids': 'comment_ids',  # noqa: E501
        ...
        'name': 'name',  # noqa: E501
        'num_tasks_completed': 'num_tasks_completed',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_url, archived, blocked, blocker, comment_ids, completed, completed_at, completed_at_override, created_at, deadline, entity_type, epic_id, estimate, external_id, external_links, external_tickets, file_ids, follower_ids, group_id, group_mention_ids, id, iteration_id, labels, linked_file_ids, member_mention_ids, mention_ids, moved_at, name, num_tasks_completed, owner_ids, position, previous_iteration_ids, project_id, requested_by_id, started, started_at, started_at_override, stats, story_links, story_type, support_tickets, task_ids, updated_at, workflow_state_id, *args, **kwargs):  # noqa: E501
