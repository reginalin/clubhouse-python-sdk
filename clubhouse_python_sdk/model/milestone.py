...
class Milestone(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'stats': (MilestoneStats,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_url, categories, completed, completed_at, completed_at_override, created_at, description, entity_type, id, name, position, started, started_at, started_at_override, state, updated_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            stats (MilestoneStats): [optional]  # noqa: E501
        """
