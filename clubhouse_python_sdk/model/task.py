...
class Task(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, complete, completed_at, created_at, description, entity_type, external_id, group_mention_ids, id, member_mention_ids, mention_ids, owner_ids, position, story_id, updated_at, *args, **kwargs):  # noqa: E501
