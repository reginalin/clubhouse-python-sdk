...
class StoryLink(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, entity_type, id, object_id, subject_id, updated_at, verb, *args, **kwargs):  # noqa: E501
        """StoryLink - a model defined in OpenAPI
