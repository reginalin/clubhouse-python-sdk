...
class Iteration(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_url, created_at, description, end_date, entity_type, follower_ids, group_ids, group_mention_ids, id, labels, member_mention_ids, mention_ids, name, start_date, stats, status, updated_at, *args, **kwargs):  # noqa: E501
