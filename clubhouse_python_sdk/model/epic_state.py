...
class EpicState(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, color, created_at, description, entity_type, id, name, position, type, updated_at, *args, **kwargs):  # noqa: E501
        """EpicState - a model defined in OpenAPI
