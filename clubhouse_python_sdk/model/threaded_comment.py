...
class ThreadedComment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'comments': ([ThreadedComment],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_url, author_id, comments, created_at, deleted, entity_type, external_id, group_mention_ids, id, member_mention_ids, mention_ids, text, updated_at, *args, **kwargs):  # noqa: E501
        """ThreadedComment - a model defined in OpenAPI
